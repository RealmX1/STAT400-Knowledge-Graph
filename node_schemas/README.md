Follow schema in examples.md to create your own nodes for yoru selected chapter/section from Stat400_Concepts (I'd recommend uploading the concept folder to overleaf)
